...
public class RealStreamBurn
{
    ...
    public static void main( String[] args )
    {
        ...
        task.PMYBS_SetTaskConfig(Constants.PMYBS_SDK_TASK_CFG_BURN_REAL_BURN_STREAM, "1");//刻录流
        ...
        //第一个文件生成开始
        SubmitTaskFile(taskId, "F:/FileName_1.dat", Constants.PMYBS_BURN_FILE_REAL | Constants.PMYBS_BURN_FILE_REAL_WRITING, false, false);
        try {
            Thread.sleep(1000);
        ...
        //第一个文件生成完成
        SubmitTaskFile(taskId, "F:/FileName_1.dat", Constants.PMYBS_BURN_FILE_REAL | Constants.PMYBS_BURN_FILE_REAL_FINISH, false, false);

        //第二个文件生成开始
        SubmitTaskFile(taskId, "F:/FileName_2.dat", Constants.PMYBS_BURN_FILE_REAL | Constants.PMYBS_BURN_FILE_REAL_WRITING, false, false);
        try {
            Thread.sleep(1000);
        } catch (InterruptedException e) {
            // TODO Auto-generated catch block
        ...
        //第二个文件生成完成
        SubmitTaskFile(taskId, "F:/FileName_2.dat", Constants.PMYBS_BURN_FILE_REAL | Constants.PMYBS_BURN_FILE_REAL_FINISH, true, true);
